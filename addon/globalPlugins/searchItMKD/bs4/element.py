...
#Later added:
import os
sys.path.append(os.path.abspath(os.path.dirname(__file__)+"\\soupsieve-2.0.1"))
import imp
try:
    a, b, c=imp.find_module("soupsieve")
    try:
        soupsieve=imp.load_module("soupsieve", a, b, c)
    except ImportError as i:
        soupsieve = None
        warnings.warn(
            'The soupsieve package is not installed. CSS selectors cannot be used.'
        )
        #print("load_module_error:"+str(i))
except ImportError as i:
    soupsieve = None
    warnings.warn(
        'The soupsieve package is not installed. CSS selectors cannot be used.'
    )
    #print("find_module_error:"+str(i))
